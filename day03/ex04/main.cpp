...
/*   Updated: 2021/01/23 19:21:36 by kcedra           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	std::cout << "---------------------------------------------------------" << std::endl;
	std::cout << "Supertrap tests" << std::endl;
	std::cout << "---------------------------------------------------------" << std::endl;

	SuperTrap	super("Super");
	SuperTrap	testsuper("Testsuper");
	SuperTrap	super2("Super 2");

	super.meleeAttack("Jack");
	super.rangedAttack("Jack");
	super.takeDamage(100);
	std::cout << "Super hitpoints = " << super.getHP() << std::endl;
	...
	std::cout << "Testsuper hitpoints = " << testsuper.getHP() << std::endl;
	testsuper = super;
	
	std::cout << "---------------------------------------------------------" << std::endl;
	
	std::cout << "Testsuper hitpoints = " << testsuper.getHP() << std::endl;
	testsuper.beRepaired(150);
	std::cout << "Testsuper hitpoints = " << testsuper.getHP() << std::endl;
	testsuper.takeDamage(100);
	std::cout << "Testsuper hitpoints = " << testsuper.getHP() << std::endl;
	testsuper.beRepaired(150);
	std::cout << "Testsuper hitpoints = " << testsuper.getHP() << std::endl;
	testsuper.takeDamage(200);

	testsuper.ninjaShoebox(newclap);
	testsuper.ninjaShoebox(newclap);
	testsuper.ninjaShoebox(newTrap);
	testsuper.ninjaShoebox(ninja);

	std::cout << "Testsuper energy points = " << testsuper.getEnergyPoints() << std::endl;
	testsuper.vaulthunter_dot_exe("Zed");
	std::cout << "Testsuper energy points = " << testsuper.getEnergyPoints() << std::endl;
	testsuper.vaulthunter_dot_exe("Jack");
	std::cout << "Testsuper energy points = " << testsuper.getEnergyPoints() << std::endl;
	testsuper.vaulthunter_dot_exe("Zed");
	std::cout << "Testsuper energy points = " << testsuper.getEnergyPoints() << std::endl;
	testsuper.vaulthunter_dot_exe("Jack");
	...
	std::cout << "Super 2 hitpoints = " << super2.getHP() << std::endl;
	super2.beRepaired(150);
	std::cout << "Super 2 hitpoints = " << super2.getHP() << std::endl;
	super2.takeDamage(100);
	std::cout << "Super 2 hitpoints = " << super2.getHP() << std::endl;
	super2.beRepaired(150);
	std::cout << "Super 2 hitpoints = " << super2.getHP() << std::endl;
	super2.takeDamage(200);
